  ...
  try {
    ...
    if (snap.exists()) {
      ...
      if (remote) {
        ...
        if (typeof window._dbg === 'function') window._dbg('pullFromCloud: remote.onboardingDone=' + remote.onboardingDone + ' S.onboardingDone=' + S.onboardingDone);
        if (!S.onboardingDone) merged.onboardingDone = false;
        if (typeof window._dbg === 'function') window._dbg('pullFromCloud: merged.onboardingDone=' + merged.onboardingDone);
        ...
        } else if (_remoteKey.startsWith('gsk_')) {
          merged.apiKey = _remoteKey;
        } else {
