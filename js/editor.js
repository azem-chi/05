...
function showOnboarding() {
  ...
  if (typeof window._dbg === 'function') window._dbg('showOnboarding: step=' + obCurrentStep + ' obEl=' + !!obEl + (obEl ? ' display='+obEl.style.display : ''));
  if (obEl) obEl.style.display = 'flex';
  if (typeof window._dbg === 'function') window._dbg('showOnboarding: after display=flex, calling renderObStep');
  try {
    renderObStep();
    if (typeof window._dbg === 'function') window._dbg('showOnboarding: renderObStep() completed OK');
  } catch(e) {
    if (typeof window._dbg === 'function') window._dbg('showOnboarding: ERROR in renderObStep: ' + e.message);
  }
}
...
function obFinish() {
  if (typeof window._dbg === 'function') window._dbg('obFinish() called');
...
function renderObStep() {
  ...
  const step = obCurrentStep;
  if (typeof window._dbg === 'function') window._dbg('renderObStep: step=' + step + ' _lang=' + _lang);
